    ...
    zod.object({
      ...
      fixtures: zod.array(
        zod.object({
          ...
          weatherTemp: zod.number().nullish(),
          weatherDesc: zod.string().nullish(),
          weatherIcon: zod.string().nullish(),
          weatherWind: zod.number().nullish(),
          weatherHumidity: zod.number().nullish(),
        }),
      ),
    }),
  ),
