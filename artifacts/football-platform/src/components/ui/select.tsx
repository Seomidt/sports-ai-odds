...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-[300] max-h-[min(70vh,28rem)] min-w-[8rem] overflow-hidden rounded-md border border-popover-border bg-popover text-popover-foreground shadow-lg shadow-black/30",
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "max-h-[min(65vh,26rem)] overflow-y-auto overflow-x-hidden overscroll-contain p-1",
          position === "popper" &&
